...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="fixed top-1/2 right-12 -translate-y-1/2 z-[999]">
      ...
      >
        {/* Profile Button at the Top when Signed In */}
        {isAuthenticated && (
              ...
              <AnimatePresence>
                {isProfileOpen && (
                  <motion.div
                    ...
                    className="absolute right-0 mt-2 w-48 bg-white shadow-lg border border-gray-300 rounded-md overflow-hidden z-20"
                  >
        ...
        {/* Sign In Button (Remains at Bottom) */}
        {!isAuthenticated && (
          <li className="mt-4 text-right relative">
            <button
